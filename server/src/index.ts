...
// Devuelve usuarios directo de la BD, para el recuadro debajo del chat
...
// Recibe el historial de mensajes del frontend, llama al modelo con getUsuarios y devuelve la respuesta en streaming
