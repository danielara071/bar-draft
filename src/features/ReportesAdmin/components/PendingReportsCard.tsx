...
const pendingReports: PendingReport[] = [
  {
    ...
    reporter: { name: "Carlos Martinez", initials: "CM", id: "101" },
    reported: {
      name: "Juan Perez",
      initials: "JP",
      id: "204",
  ...
  },
  {
    ...
    reporter: { name: "Maria Garcia", initials: "MG", id: "142" },
    reported: {
      name: "Pedro Lopez",
      initials: "PL",
      id: "208",
              ...
              <div className="rounded-xl bg-brand-gray-light/30 p-4">
                ...
                <div className="mt-3 flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-brand-gray-mid">ID: {report.reporter.id}</p>
                  </div>
                </div>
              </div>
              ...
              <div className="rounded-xl bg-brand-yellow/10 p-4">
                ...
                <div className="mt-3 flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-brand-gray-mid">ID: {report.reported.id}</p>
                  </div>
                </div>
