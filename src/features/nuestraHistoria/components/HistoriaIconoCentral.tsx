...
const HistoriaIconoCentral = ({ icon: Icon }: HistoriaIconoCentralProps) => {
  return (
    <div className="hidden md:flex md:items-start md:justify-center">
      <div className="relative mt-2 flex h-16 w-16 items-center justify-center rounded-full border-2 border-brand-crimson bg-brand-white text-brand-crimson shadow-[0_18px_40px_rgba(15,45,82,0.15)]">
