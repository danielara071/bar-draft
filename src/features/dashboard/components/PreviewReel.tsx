...
const PreviewReel = ({ video_url, muted, changeMute }: PreviewReelProps) => {
  ...
  return (
    <motion.div
      className="relative overflow-hidden rounded-2xl shadow-md shadow-black group cursor-pointer h-80 w-60"
      onClick={() => {
        togglePlay();
      }}
    >
